...
class UI(QDialog):
    ...
    def __init__(self):
        ...
        root_layout.addLayout(browser_layout, 1, 1, 1, 2)
        
        # Generation
        gen_layout = QVBoxLayout()
        root_layout.addLayout(gen_layout, 0, 1, 1, 2)
        ...
        # Utterance box
        browser_layout.addWidget(QLabel("<b>\tUse embedding from:</b>"), 1, 0)
        self.utterance_history = QComboBox()
        browser_layout.addWidget(self.utterance_history, 1, 1, 1, 2)
        # i += 1
        
        # Random & next utterance buttons
        self.browser_browse_button = QPushButton("Browse")
        browser_layout.addWidget(self.browser_browse_button, 2, 0)
        self.record_button = QPushButton("Record")
        # browser_layout.addWidget(self.record_button, 0, 1)
        self.play_button = QPushButton("Play")
        browser_layout.addWidget(self.play_button, 2, 1)
